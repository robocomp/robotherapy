...
/** \mainpage RoboComp::therapyAnalysis
 *
 * \section intro_sec Introduction
 *
 * The therapyAnalysis component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/therapyAnalysis --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class therapyAnalysis : public RoboComp::Application
{
public:
	therapyAnalysis (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::therapyAnalysis::initialize()
{
...
int ::therapyAnalysis::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
