...
/** \mainpage RoboComp::humanTherapySaver
 *
 * \section intro_sec Introduction
 *
 * The humanTherapySaver component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/humanTherapySaver --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class humanTherapySaver : public RoboComp::Application
{
public:
	humanTherapySaver (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::humanTherapySaver::initialize()
{
...
int ::humanTherapySaver::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
