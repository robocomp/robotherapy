...
if __name__ == '__main__':
    ...
    therapymetricsTopic = RoboCompTherapyMetrics.TherapyMetricsPrx.uncheckedCast(pub)
    ...
    adapter.add(admintherapyI.AdminTherapyI(worker), ic.stringToIdentity('admintherapy'))
    adapter.activate()


    HumanTrackerJointsAndRGB_adapter = ic.createObjectAdapter("HumanTrackerJointsAndRGBTopic")
    humantrackerjointsandrgbI_ = humantrackerjointsandrgbI.HumanTrackerJointsAndRGBI(worker)
